...
function runRoundtrip(
  ...
  // eslint-disable-next-line no-useless-assignment -- o tracks byte offset through buffer
  configData[o++] = 0x00;
  ...
  // Encode
  const audio = encoder.encodeFramedBlocks(allFramed);
