 ...
 */
export function decompress(compressed: Uint8Array, scheme: number): Uint8Array {
  switch (scheme) {
    case 0x01:
 ...
 */
export function getCompressionStats(data: Uint8Array, scheme: number): CompressionStats {
