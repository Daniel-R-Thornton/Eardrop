...
export class SquawkProcessor {
  ...
  processSquawk(
    ...
    for (let t = 0; t < 4; t++) {
      ...
      toneSnr[t] = measuredMag > 1e-12 && noiseMag > 1e-12
        ? 20 * Math.log10(measuredMag / noiseMag)
        : 40; // cap at 40 dB
    }
