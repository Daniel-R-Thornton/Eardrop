...
function encodeBCHHeader(rawHeader: Uint8Array): Uint8Array {
  ...
  c1[0] = rawHeader[0]; c1[1] = rawHeader[1]; c1[2] = rawHeader[2]; c1[3] = 0;
  const cw1 = bchEncode4Bytes(c1);

  // Chunk 2: bytes 3-5 + zero
  const c2 = new Uint8Array(4);
  c2[0] = rawHeader[3]; c2[1] = rawHeader[4]; c2[2] = rawHeader[5]; c2[3] = 0;
  ...
  c3[0] = rawHeader[6]; c3[1] = rawHeader[7]; c3[2] = rawHeader[8]; c3[3] = 0;
